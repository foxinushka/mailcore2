...
static ErrorCode addFile(zipFile file, String * path)
{
    ...
    if (S_ISDIR(statinfo.st_mode)) {
        ...
        WIN32_FIND_DATA ffd;
		hFind = FindFirstFile(reinterpret_cast<LPCWSTR>(wildcard->unicodeCharacters()), &ffd);
        ...
        do {
            ...
            String * subpath = path->stringByAppendingPathComponent(String::stringWithCharacters(reinterpret_cast<UChar *>(ffd.cFileName)));
            addFile(file, subpath);
        }
