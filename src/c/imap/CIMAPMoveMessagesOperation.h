...
extern "C" {
    ...
    CMAILCORE_EXPORT C_SYNTHESIZE_COBJECT_CAST_DEFINITION(CIMAPMoveMessagesOperation)
    CMAILCORE_EXPORT C_SYNTHESIZE_FUNC_DEFINITION(CIMAPMoveMessagesOperation, CDictionary, uidMapping)
