...
public class IMAPNamespaceItem {
    ...
    public var prefix: String? {
        ...
        set { String.utf16(newValue, { nativeInstance.setPrefix(nativeInstance, $0) }) }
    }
    ...
    public func components(path: String) -> Array<String> {
        return Array<String>.cast( String.utf16(path, { nativeInstance.componentForPath(nativeInstance, $0) }));
    }
    
    /** Returns YES if the namespace contains this folder path */
    public func containsFolder(folder: String) -> Bool {
        return String.utf16(folder, { nativeInstance.containsFolder(nativeInstance, $0) })
    }
