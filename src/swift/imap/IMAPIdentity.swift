...
public class IMAPIdentity {
    ...
    public var vendor: String? {
        ...
        set { String.utf16(newValue, { nativeInstance.setVendor(nativeInstance, $0) }) }
    }
    
    /** Name of the IMAP client */
    public var name: String? {
        get { return String(utf16: nativeInstance.name(nativeInstance)); }
        set { String.utf16(newValue, { nativeInstance.setName(nativeInstance, $0) }) }
    }
    
    /** Version of the IMAP client */
    public var version: String? {
        get { return String(utf16: nativeInstance.version(nativeInstance)); }
        set { String.utf16(newValue, { nativeInstance.setVersion(nativeInstance, $0) }) }
    }
    ...
    public func infoForKey(_ key: String) -> String? {
        return String.utf16(key, { String(utf16: nativeInstance.infoForKey(nativeInstance, $0)) })
    }
